            ...
            <span id="services">
              <a className="spe" onClick={first}>
                <div className="sliderOption">
                  ...
                  <span className="littleBody">
                    For the problems as Surveillance, Monitoring and
                    Enforcement, detecting and tracking objects in videos.
                  </span>
                </div>
              </a>
              ...
              <a className="spe" onClick={second}>
                <div className="sliderOption">
                  ...
                  <span className="littleBody">
                    For classification of images to assign them different
                    classes.
                  </span>
                </div>
              </a>
              ...
              <a className="spe" onClick={third}>
                <div className="sliderOption">
                  ...
                  <br />
                  <span className="littleBody">
                    For object detection, localization using 2-dimensional or
                    3-dimensional bounding boxes.
                  </span>
                </div>
              </a>
