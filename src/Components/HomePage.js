          ...
          <span id="services">
            <div className="sliderOption">
              ...
              <span className="littleBody">
                Every pixel in an image is painstakingly masked by our in house
                team of talented human cloud workers. Combine their skills with
                your knowledge to make the most valuable data.
              </span>
            </div>
            <div className="sliderOption">
              ...
              <br />
              <span className="littleBody">
                Masks are highly accurate and beautiful and are made by skilled
                professionals. Bounding Boxes can be upgraded to Masks only if
                required, make only the Masks you need.
              </span>
            </div>
            <div className="sliderOption">
              <span className="littleHeading">Bounding Boxes</span> <br />
              <span className="littleBody">
                Bounding Boxes are quick and cheap to make, especially with
                experience. Labelling boxes sometimes requires domain expertise,
                we have experts in house, or bring your own.
              </span>
            </div>
          </span>
        </section>
